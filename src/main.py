...
directory_cleaner = DirectoryCleaner(base_dir=settings.NODE_LOGS_PATH, hyperliquid_data_dir=settings.NODE_LOGS_PATH_HYPERLIQUID, single_file_watcher=single_file_tail_watcher)
